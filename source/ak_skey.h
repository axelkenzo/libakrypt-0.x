...
/*! \brief Флаг того, что внутреннее состояние синхропосылки для режима гаммирования с обратной связью по выходу установлено в истинное значение. */
 #define ak_flag_ofb_update      (0x0010)
...
/*! \brief Структура секретного ключа -- базовый набор данных и методов контроля. */
 ...
 /*! \brief Флаги текущего состояния ключа */
   ak_uint64 flags;
 /*! \brief Размер блока входяшего сообщения */
   size_t block_size;
