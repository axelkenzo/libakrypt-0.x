...
/*! Класс предоставляет интерфейс для реализации различных бесключевых алгоритмов хеширования
    ...
    Американские алгоритмы хэширования
     - SHA-224 (SHA-2)
     - SHA-256 (SHA-2)
     - SHA-384 (SHA-2)
     - SHA-512 (SHA-2)
...
/*! \brief Инициализация контекста функции бесключевого хеширования SHA-224 (SHA-2). */
 int ak_hash_create_sha224( ak_hash );
/*! \brief Инициализация контекста функции бесключевого хеширования SHA-256 (SHA-2). */
 int ak_hash_create_sha256( ak_hash );
/*! \brief Инициализация контекста функции бесключевого хеширования SHA-512 (SHA-2). */
 int ak_hash_create_sha512( ak_hash );
/*! \brief Инициализация контекста функции бесключевого хеширования SHA-384 (SHA-2). */
 int ak_hash_create_sha384( ak_hash );
/*! \brief Инициализация контекста функции бесключевого хеширования SHA-512/256 (SHA-2). */
 int ak_hash_create_sha512_256( ak_hash );
/*! \brief Инициализация контекста функции бесключевого хеширования SHA-512/224 (SHA-2). */
 int ak_hash_create_sha512_224( ak_hash );
...
/*! \brief Проверка корректной работы функции хеширования SHA-224 (SHA-2) */
 ak_bool ak_hash_test_sha224( void );
/*! \brief Проверка корректной работы функции хеширования SHA-256 (SHA-2) */
 ak_bool ak_hash_test_sha256( void );
/*! \brief Проверка корректной работы функции хеширования SHA-384 (SHA-2) */
 ak_bool ak_hash_test_sha384( void );
/*! \brief Проверка корректной работы функции хеширования SHA-512 (SHA-2) */
 ak_bool ak_hash_test_sha512( void );
/*! \brief Проверка корректной работы функции хеширования SHA-512/256 (SHA-2) */
 ak_bool ak_hash_test_sha512_256( void );
/*! \brief Проверка корректной работы функции хеширования SHA-512/224 (SHA-2) */
