...
/*! \brief Ошибка, возникающая когда длина сообщений, зашифровываемых в режиме простой замены с зацеплением,
   должна быть кратна длине блока базового алгоритма блочного шифрования.
 */
#define ak_error_message_wrong_size            (-45)
